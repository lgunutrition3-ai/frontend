...
const PotableWaterEntry = () => {
  ...
  const handleBatchDelete = async () => {
    ...
    try {
      await potableWaterApi.deleteMany(selectedIds)
      setSelectedIds([])
      fetchRecords()
    } catch (error) {
      ...
      <Card className="mb-4" ref={formCardRef}>
        ...
        <Card.Body>
          ...
          <GuidePanel open={showGuide}>
            <strong>Potable Water Survey</strong>
            <ul className="mb-0 ps-3">
              <li><strong>Purok, Household Name, Record Date</strong> — all required. Household names autocomplete from existing records.</li>
              <li><strong>Water Source Levels</strong> — switch ON each water access level the household uses:</li>
              <li><strong>Level 1</strong> — point source (well/spring); <strong>Level 2</strong> — communal faucet; <strong>Level 3</strong> — individual/piped household connection.</li>
